  ...
  return (
    <div className="landingPage">
          ...
          <div className="Flight-search-container input-container mb-4">
                  ...
                  <div className='Flight-search-container-body'>
                    ...
                    <div className="form-floating mb-3">
                      <input type="date" className="form-control" id="floatingInputstartDate" value={departureDate} onChange={(e)=>setDepartureDate(e.target.value)} min={new Date().toISOString().split('T')[0]} />
                      <label htmlFor="floatingInputstartDate">Journey date</label>
                    </div>
                    {checkBox ?
                    
                      <div className="form-floating mb-3">
                        <input type="date" className="form-control" id="floatingInputreturnDate" value={returnDate} onChange={(e)=>setReturnDate(e.target.value)} min={new Date().toISOString().split('T')[0]} />
        ...
        <div className="container">
            ...
            <span><h5>2026 SB FlightConnect - &copy; All rights reserved</h5></span>
